...
public class RadianiteBoxBlock2x2 extends HorizontalFacingBlock {
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    public static final IntProperty MODEL_INDEX = IntProperty.of("model_index", 0, 3);

    public RadianiteBoxBlock2x2(Settings settings) {
        super(settings);
    }
